...
/**
 * @file ml_synth_fm_example.ino
 * @author Marcel Licence
 *
 * this file should be opened with arduino, this is the main project file
 *
 * @brief   This projects replaces https://github.com/marcel-licence/esp32_fm_synth
 *          It supports multiple platforms and uses the ml_fm_synth module of ML_SynthTools
 *
 * shown in: https://youtu.be/rGTw05GKwvU (ESP32 version)
 */
